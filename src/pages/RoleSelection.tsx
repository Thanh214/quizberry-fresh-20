      ...
      <div className="flex flex-col min-h-screen pb-10">
        ...
        >
          ...
          <motion.div 
            ...
            whileHover="hover"
          >
            <div className="absolute -top-8 -right-8 w-16 h-16 rounded-full bg-festival-gold opacity-20 animate-float hidden md:block"></div>
          ...
          <div className="mb-10 text-center relative">
            <motion.h1 
              className={`text-4xl xs:text-5xl font-bold mb-3 ${seasonStyles.textTitle} drop-shadow-sm relative inline-block`}
              variants={titleEffect}
            >
              <motion.div
                className="absolute -top-6 -left-6 hidden xs:block"
                variants={sparkleVariants}
              >
                <Sparkles className="h-5 w-5 text-festival-gold animate-pulse" />
              </motion.div>
              <motion.span className="absolute -top-3 -right-3 w-4 h-4 rounded-full bg-festival-gold opacity-80 animate-pulse hidden xs:block"></motion.span>
              EPUTest
              <motion.span className="absolute -bottom-1 -left-1 w-3 h-3 rounded-full bg-festival-pink opacity-70 hidden xs:block"></motion.span>
              <motion.div
                className="absolute -bottom-6 -right-6 hidden xs:block"
                variants={sparkleVariants}
              >
            ...
            <motion.p 
              className="text-lg xs:text-xl text-muted-foreground"
              variants={titleEffect}
            >
          ...
          <div className="grid gap-6 md:gap-8 grid-cols-1 xs:grid-cols-2 w-full max-w-2xl px-4">
            {/* Teacher card */}
            <motion.div 
            ...
            >
              ...
              {/* Decorative elements */}
              <div className={`absolute -top-12 -left-12 w-24 h-24 rounded-full ${seasonStyles.teacherDecoration} hidden sm:block`}></div>
              <div className={`absolute -bottom-20 -right-20 w-40 h-40 rounded-full ${seasonStyles.teacherDecoration} hidden sm:block`}></div>
            </motion.div>
            ...
            >
              ...
              {/* Decorative elements */}
              <div className={`absolute -top-16 -right-16 w-32 h-32 rounded-full ${seasonStyles.studentDecoration} hidden sm:block`}></div>
              <div className={`absolute -bottom-24 -left-24 w-48 h-48 rounded-full ${seasonStyles.studentDecoration} hidden sm:block`}></div>
            </motion.div>
          </div>
